...
export default function Generate() {
  ...
  const handleGenerateLink = () => {
    if(existingId){
      setGeneratedLink(`https://love-calculator-murex-seven.vercel.app/calculate?id=${existingId}`);
      return;
    }
    ...
    setExistingId(id);
    setGeneratedLink(`https://love-calculator-murex-seven.vercel.app/calculate?id=${id}`);
